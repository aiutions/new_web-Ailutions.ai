...
export const InteractiveCaseStudyCard = ({ title, metric, problem, solution, outcome, details }) => {
  const [isFlipped, setIsFlipped] = useState(false);
  
  const handleReadFullCase = () => {
    alert(`This will navigate to full case study page for ${title}`);
  };
