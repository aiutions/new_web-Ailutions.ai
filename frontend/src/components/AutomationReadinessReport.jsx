...
export default function AutomationReadinessReport({ results, userInfo, onBack }) {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input, { 
      ...
      let position = 0;
      const pageHeight = (pdfWidth / canvasWidth) * canvasHeight;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-10">
        <div ref={reportRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white py-12">
          <div className="border-b-2 border-purple-600 pb-8 mb-10">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Ailutions</h1>
                <p className="text-lg text-gray-600">Automation Readiness Report</p>
              </div>
              <img src="https://customer-assets.emergentagent.com/job_ai-lead-toolkit/artifacts/lr58t0dk_ailutions.%20logo.svg" alt="Ailutions Logo" className="h-12" />
            </div>
          </div>
